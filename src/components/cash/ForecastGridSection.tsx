...
/**
 * Month-by-month detail of the Cash « Prévisionnel » tab: the undated
 * committed pipeline of signed deals, then the category × month grid
 * merging the realized, committed and planned layers
 * (forecasts.getForecastGrid — current-month consumption, cf. KNOWN_ISSUES
 * « Cash flow forecast »). Moved out of the overview cockpit, which keeps
 * the KPI band and the curve (ForecastOverview).
 */
export function ForecastGridSection({
  orgId,
}: {
