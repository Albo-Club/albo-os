...
## v1.229.1 — 14/09/2026 à 15:07 — Mise à jour des dépendances

Mise à jour technique hebdomadaire des briques logicielles de l'app
(37 brique(s) logicielle(s) mises à jour). Aucun changement visible dans l'app.
...
> - `@convex-dev/workpool` 0.4.6 → 0.4.12
