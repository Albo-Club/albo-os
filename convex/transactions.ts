...
/**
 * Attaches a transaction to a deal in the same org. Realizing a forecast
 * entry is a separate, explicit gesture (forecasts.markEntryRealized) —
 * pointing never proposes one.
 */
