 ...
 *
 * Pure, dependency-free (mirrors convex/lib/royalties.ts so it stays testable).
 ...
 * transactions (de-VAT'd HT). Day-count is actual/365 via the shared
 * `MS_PER_YEAR` from `./metrics`.
 *
...
import { MS_PER_YEAR } from './metrics'
